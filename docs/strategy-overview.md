...
| LAUNCH_READY | 次日值得重点盯盘的转强候选（接近 S1 / 近期高点属 geometry 特征，不构成确认） |
| SECOND_LAUNCH | 第二次攻击确认：突破关键 trigger / 前高 / 压力区，并形成有效强势扩张 |
| POST_B | 主要启动段已经兑现，进入持仓管理 / 延续观察阶段；新开仓通常 NO_CHASE |

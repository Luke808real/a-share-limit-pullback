...
REF-R6 verbatim move of `strategy/scoring.py` (target: selection/ranking).
Ranking consumes prepared facts and returns a frozen ScoreBreakdown; it reads
no providers, bars outside the supplied window, or filesystem, and it never
mutates state.
"""

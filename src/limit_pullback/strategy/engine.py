...
REF-R5 slice 1: the state-transition helpers moved verbatim to
`limit_pullback.state.engine_helpers`; `evaluate_strategy` orchestration stays
here and imports them back, so behavior is byte-identical.
"""

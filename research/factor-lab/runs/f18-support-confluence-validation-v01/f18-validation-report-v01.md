...
## ACCOUNTING
- RESOLVED_N = 9625；F18_DEFINED_N = 9594；F18_UNDEFINED_N = 31
- ANALYSIS_DEFINED_N = 9594；PRIMARY_N_SUM = 9594
- CONFLUENCE_N = 6634；NON_CONFLUENCE_N = 2960
...
| N | 6634 | 2960 |  |
| WIN_S1 | 1586 | 742 |  |
| LOSS_INVALID | 3759 | 1745 |  |
| CANCEL_GAP_INVALID | 1289 | 473 |  |
| strict_win_rate | 0.296726 | 0.298351 | -0.001625 |
| R_DEFINED_N | 5345 | 2487 |  |
| mean_R | -0.072509 | -0.020167 | -0.052342 |
| median_R | -1.0 | -1.0 | 0.0 |
| P(R>0) | 0.241534 | 0.248492 | -0.006958 |
| P(R>=2) | 0.048082 | 0.036188 |  |
...
- NON_CONFLUENCE: {'p90_R': 0.57824, 'p95_R': 1.25346, 'p99_R': 19.806062, 'max_R': 109.0, 'top1pct_R_contribution': -17.337097, 'trim_top1pct_mean_R': -0.37341}
...
- B1_READY: N 双方 4400/1980，Δstrict_win_rate=0.014315，ΔP(R>0)=0.014315
...
- T1-2: N 双方 4790/2000，Δstrict_win_rate=0.003161，ΔP(R>0)=0.003161
- T3: N 双方 782/466，Δstrict_win_rate=-0.010167，ΔP(R>0)=-0.02488
- T4-5: N 双方 615/306，Δstrict_win_rate=0.078612，ΔP(R>0)=0.047571
